...
export default function RecipeModal({ recipeId, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl bg-gray-900 border border-gray-800 shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        <button
          onClick={onClose}
          className="absolute top-3 right-3 z-10 rounded-full bg-gray-800 p-1.5 text-gray-400 hover:bg-gray-700 hover:text-gray-100 transition"
        >
          ✕
        </button>
            ...
            <div className="p-6 flex flex-col gap-4">
              ...
              {data.sourceUrl && (
                <a
                  ...
                  className="mt-2 block text-center rounded-lg bg-green-800 py-2.5 text-sm font-semibold text-green-100 hover:bg-green-700 transition"
                >
                  View full recipe ↗
                </a>
              )}
